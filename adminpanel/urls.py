...
urlpatterns = [
    ...
    path('finance/section/<str:section>/', views.finance, name='finance_section'),
    path('finance-readonly/section/<str:section>/', views.finance_readonly, name='finance_readonly_section'),
