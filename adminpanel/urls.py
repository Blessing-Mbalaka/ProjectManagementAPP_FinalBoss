...
urlpatterns = [
    ...
    path('crm/reports/data/', views.crm_reporting_data, name='crm_reporting_data'),
    path('crm/reports/export/<str:period>/', views.crm_report_export, name='crm_report_export'),
    path('crm/<str:tab>/', views.crm, name='crm_tab'),
    ...
    path('finance/expenses/template/', views.download_expense_import_template, name='download_expense_import_template'),
    path('finance/expenses/upload/', views.upload_expense_excel, name='upload_expense_excel'),
    path('finance/export-summary/', views.download_finance_summary_excel, name='download_finance_summary_excel'),
